...
use AbdelrahmanMedhat\Cashier\Exceptions\InvalidPaymentMethod;
use LogicException;
...
class PaymentMethod implements Arrayable, Jsonable, JsonSerializable
{
     ...
     * @return void
     *
     * @throws \AbdelrahmanMedhat\Cashier\Exceptions\InvalidPaymentMethod
     */
    public function __construct($owner, StripePaymentMethod $paymentMethod)
    {
        ...
        if ($owner->cashier_stripe_id !== $paymentMethod->customer) {
