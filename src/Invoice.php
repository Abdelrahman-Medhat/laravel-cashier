...
use AbdelrahmanMedhat\Cashier\Contracts\InvoiceRenderer;
use AbdelrahmanMedhat\Cashier\Exceptions\InvalidInvoice;
...
class Invoice implements Arrayable, Jsonable, JsonSerializable
{
     ...
     *
     * @var \AbdelrahmanMedhat\Cashier\InvoiceLineItem[]
     */
    protected $items;
     ...
     *
     * @var \AbdelrahmanMedhat\Cashier\Tax[]
     */
    protected $taxes;
     ...
     *
     * @var \AbdelrahmanMedhat\Cashier\Discount[]
     */
    protected $discounts;
     ...
     * @return void
     *
     * @throws \AbdelrahmanMedhat\Cashier\Exceptions\InvalidInvoice
     */
     ...
     *
     * @return \AbdelrahmanMedhat\Cashier\Discount[]
     */
     ...
     *
     * @param  \AbdelrahmanMedhat\Cashier\Discount  $discount
     * @return string|null
     */
     ...
     *
     * @return \AbdelrahmanMedhat\Cashier\Tax[]
     */
     ...
     *
     * @return \AbdelrahmanMedhat\Cashier\InvoiceLineItem[]
     */
