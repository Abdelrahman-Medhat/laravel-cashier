...
class SubscriptionBuilder
{
     ...
     *
     * @var \AbdelrahmanMedhat\Cashier\Billable|\Illuminate\Database\Eloquent\Model
     */
    protected $owner;
     ...
     * @return \AbdelrahmanMedhat\Cashier\Subscription
     *
    ...
    protected function createSubscription(StripeSubscription $stripeSubscription)
    {
        ...
        $subscription = $this->owner->subscriptions()->create([
            ...
            'cashier_trial_ends_at' => ! $this->skipTrial ? $this->trialExpires : null,
            'ends_at' => null,
        ]);
     ...
     * @param  array  $customerOptions
     * @return \AbdelrahmanMedhat\Cashier\Checkout
     */
